        ...
        return switch (handlerType) {
            case "simple_semaphore" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) {
                    ...
                    Main.intersection = new SimpleIntersection();
                }
            };
            case "simple_n_roundabout" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    ...
                    Semaphore s = new Semaphore(Integer.parseInt(line[0]));
                    Main.intersection = new SimpleNRoundabout(Integer.parseInt(line[0]), Integer.parseInt(line[1]), s);
                }
            };
            case "simple_strict_1_car_roundabout" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    String[] line = br.readLine().split(" ");
                    Main.intersection = new SimpleStrict1Roundabout(Integer.parseInt(line[0]), Integer.parseInt(line[1]));
                }
            };
            case "simple_strict_x_car_roundabout" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    String[] line = br.readLine().split(" ");
                    Main.intersection = new SimpleStrictXRoundabout(Integer.parseInt(line[0]),
            ...
            case "simple_max_x_car_roundabout" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    String[] line = br.readLine().split(" ");
                    Main.intersection = new SimpleMaxXRoundabout(Integer.parseInt(line[0]),
                            Integer.parseInt(line[1]),
                            Integer.parseInt(line[2]));
                }
            };
            ...
            case "crosswalk" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    ...
                    Main.pedestrians = new Pedestrians(Integer.parseInt(line[0]),
                            Integer.parseInt(line[1]));
                }
            };
            case "simple_maintenance" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    String[] line = br.readLine().split(" ");
                    Main.intersection = new SimpleMaintenance(Integer.parseInt(line[0]));
                }
            };
            case "complex_maintenance" -> new ReaderHandler() {
                ...
                public void handle(final String handlerType, final BufferedReader br) throws IOException {
                    String[] line = br.readLine().split(" ");
                    Main.intersection = new ComplexMaintenance(
